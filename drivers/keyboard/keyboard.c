...
unsigned char get_key_char(unsigned char key){
	...
	case KEY_PRESSED_BACKSLASH: return shift?'|':'\\';
	case KEY_PRESSED_1: return shift?'!':'1';
	case KEY_PRESSED_2: return shift?'"':'2';
	case KEY_PRESSED_3: return shift?'#':'3';
	case KEY_PRESSED_4: return shift?'$':'4';
	case KEY_PRESSED_5: return shift?'%':'5';
	case KEY_PRESSED_6: return shift?'^':'6';
	case KEY_PRESSED_7: return shift?'&':'7';
	case KEY_PRESSED_8: return shift?'*':'8';
	case KEY_PRESSED_9: return shift?'(':'9';
	case KEY_PRESSED_0: return shift?')':'0';

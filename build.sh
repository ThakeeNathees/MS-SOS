...
if [ "$1" = "start" ]; then
  ...
  gcc -m32 -o ./kernel/shell.o -c ./kernel/shell.c -nostdlib -nostartfiles -nodefaultlibs
  ...
  ld -T ./boot/linker.ld -m elf_i386 -o os.bin ./boot/boot.o ./drivers/cursor.o ./drivers/keyboard/keyhandler.o ./drivers/keyboard/keyboard.o ./drivers/screen.o ./drivers/ports.o ./kernel/kernel.o ./kernel/shell.o
